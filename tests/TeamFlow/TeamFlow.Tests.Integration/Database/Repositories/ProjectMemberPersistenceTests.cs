...
public sealed class ProjectMemberPersistenceTests : IClassFixture<DatabaseFixture>, IAsyncLifetime
{
    ...
    public ProjectMemberPersistenceTests(DatabaseFixture fixture)
    {
        _fixture = fixture;
    }
