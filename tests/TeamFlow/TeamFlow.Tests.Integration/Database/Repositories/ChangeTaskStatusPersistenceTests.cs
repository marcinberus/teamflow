...
public sealed class ChangeTaskStatusPersistenceTests : IClassFixture<DatabaseFixture>, IAsyncLifetime
{
    ...
    public ChangeTaskStatusPersistenceTests(DatabaseFixture fixture)
    {
        _fixture = fixture;
    }
