...
public sealed class RemoveProjectMemberPersistenceTests : IClassFixture<DatabaseFixture>, IAsyncLifetime
{
    ...
    public RemoveProjectMemberPersistenceTests(DatabaseFixture fixture)
    {
        _fixture = fixture;
    }
